...
const PublicFooter = () => {
  return (
    <footer className="bg-zinc-900 sticky bottom-0 mt-20">
      <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
            ...
            <Link to="/login" className="w-full px-5 py-2  tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#40ad7e] rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-[#49d196] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80 font-extrabold text-lg">
              Get started
            </Link>
          </div>
        </div>
