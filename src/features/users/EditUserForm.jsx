...
const EditUserForm = ({ user }) => {
  ...
  const content = (
    <>
      ...
      <form className="m-10" onSubmit={(e) => e.preventDefault()}>
        <h2 className="m-5 text-3xl">Edit User</h2>
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          ...
          <div className="relative z-0 w-full mb-6 group">
            <select
              id="roles"
              name="roles"
              className={`bg-gray-50 m-10 border border-gray-300 cursor-pointer text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
